          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <Link
                ...
                target="_blank"
                className="mt-4 block w-full rounded-md bg-zinc-900 px-4 py-2 text-center text-sm font-medium text-white hover:bg-zinc-800 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-200 transition-colors"
              >
            ...
            <div className="rounded-lg border border-zinc-200 bg-white p-6 dark:border-zinc-800 dark:bg-zinc-900">
              ...
              <dl className="mt-4 space-y-3 text-sm">
                ...
                <div>
                  <dt className="text-zinc-600 dark:text-zinc-400">Your Role</dt>
                  <dd className="mt-1 font-medium capitalize text-zinc-900 dark:text-zinc-50">
                    {userRole}
                  </dd>
                </div>
